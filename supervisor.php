...
<title>CHEDFLAS - Supervisor Archive</title>
...
<td><a href="downloads.php?file_id=<?php echo $file['id'] ?>" class="btn btn-primary"><span class="glyphicon glyphicon-download-alt"></span></a>



<button type="button"  data-toggle="modal" data-target="#modalDocument" class="btn btn-warning"><span class="glyphicon glyphicon-modal-window"></span></button>	

<button type="button"  data-toggle="modal" data-target="#myModal" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></button>
